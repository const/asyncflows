package net.sf.asyncobjects.protocol.http.common.content; // NOPMD
...
import net.sf.asyncobjects.nio.util.DeflateOutput;
import net.sf.asyncobjects.nio.util.GZipInput;
import net.sf.asyncobjects.nio.util.GZipOutput;
import net.sf.asyncobjects.nio.util.InflateInput;
...
public final class ContentUtil {
     ...
     */
    private static AOutput<ByteBuffer> export(final AConsumer<StreamFinishedEvent> listener,
                                              final AOutput<ByteBuffer> stream) {
        return NIOExportUtil.export(Vat.current(), CountingOutput.countIfNeeded(stream, listener));
    }
     ...
     * @return the exported stream
     */
    private static AInput<ByteBuffer> export(final AConsumer<StreamFinishedEvent> listener,
                                             final AInput<ByteBuffer> stream) {
        return NIOExportUtil.export(Vat.current(), CountingInput.countIfNeeded(stream, listener));
    }
